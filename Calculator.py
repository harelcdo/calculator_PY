...
class Calc():
    ...
    def cos(self):
        self.result = False
        self.current = math.cos(math.radians(txtDisplay.get()))
        self.display(self.current)

    def sin(self):
        self.result = False
        self.current = math.sin(math.radians(txtDisplay.get()))
        self.display(self.current)

    def tan(self):
        self.result = False
        self.current = math.tan(math.radians(txtDisplay.get()))
        self.display(self.current)
...
btnSq = Button(calc, width=6, height=2, text="Sqr", font=('arial', 16, 'bold'), bd=4, bg="gainsboro",
